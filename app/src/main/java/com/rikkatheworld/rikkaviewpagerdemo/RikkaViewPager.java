...
public class RikkaViewPager extends ViewGroup {
    ...
    //最小滑动距离 = 15
    private static final float MIN_SLOP_DISTANCE = 15;
    ...
    public RikkaViewPager(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RikkaViewPager(Context context, AttributeSet attrs, int defStyleAttr) {
